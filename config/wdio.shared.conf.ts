...
export const config: WebdriverIO.Config = {
    ...
    /**
     * Function to be executed after all tests (in Mocha/Jasmine only)
     * @param {number}   result.error     error object in case the test fails, otherwise `undefined`
     * @param {RemoteCapability}     capabilities    capabilities
     * @param {string[]}  specs  duration of test
     */
